...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/broad-wind-eca7
```

A live public deployment of this template is available at [https://broad-wind-eca7.templates.workers.dev](https://broad-wind-eca7.templates.workers.dev)
